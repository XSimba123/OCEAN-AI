...
MODEL_PATH = '/home/xujingning/ocean/ocean_data/alex_model/'
EPOCH = 10
...
total_imgs_train, total_imgs_test, total_labels_train, total_labels_test = train_test_split(imgs, labels, test_size=0.2, random_state=42)
...
# print(len(xx), len(yy))
# print(xx.shape)
# total_imgs_train = np.array(xx)
# total_labels_train = np.array(yy)
# total_imgs_train=total_imgs_train.astype(np.float32)
